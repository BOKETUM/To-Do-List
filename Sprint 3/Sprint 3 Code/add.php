...
<table width="50%" border="1" align="center">
    ...
    <th width="300" style="background-color: #2BF5DD;"> <div align="center">Priority</div></th>
	<th width="50%" style="background-color: #2BF5DD;"> <div align="center">Title</div></th>
...
?>
	...
	<th width="300" > <div align="center"> <?php if($olist[priority]==1){ echo normal;}
							 else if($olist[priority]==2){echo 	important;} 
							 else {echo very_important;} ?> 
    </div></th>
    <th width="1000" > <div align="center"> <?php echo $olist[Title]?></div></th>
...
?>
	...
	<th width="300" > <div align="center"> <?php if($olist[priority]==1){ echo normal;}
							 ...
							 else {echo very_important;}?></div></th>
    <th width="1000" > <div align="center"> <?php echo $olist[Title]?></div></th>
	<th width="120"><div align="center"><?php list($y,$m,$d)=explode('-',$olist[Date]);echo $d.'/'.$m.'/'.$y;?></div></th>
 	<th><textarea name="detailEd" row="3" cols="30" readonly ><?php  echo $olist["Detail"];?></textarea></td>
	<th width="50"> <div align="center"><a class="various iframe" href onClick="window.open('edit.php?editTi=<?php echo $olist[Title];?>','','width=800,height=200'); return false;" ';}">Edit</a></div></td>  
